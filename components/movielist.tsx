        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
            ...
            {movies.results?.map((movie)=>(
                ...
                <div className="bg-gray-100 rounded-lg shadow-xl overflow-hidden transform hover:scale-105 transition duration-300 group">
                    ...
                    <div className="p-4">
                        <h3 className="text-lg font-semibold text-gray-900 group-hover:text-indigo-600 transition duration-300 line-clamp-1">{mediaType==='tv'?movie?.name:movie.title}</h3>
